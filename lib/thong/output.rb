module Thong
  ...
  # the Thong::Output module.
  #
  # Examples
  #
  #   Thong::Output.format("Hello World", :color => "cyan")
  #   # => "\e[36mHello World\e[0m"
  #
  #   Thong::Output.print("Hello World")
  #   # Hello World => nil
  #
  #   Thong::Output.puts("Hello World", :color => "underline")
  #   # Hello World
  #   # => nil
  module Output
    ...
    # Example
    #
    #   Thong::Output.puts("Hello World", :color => "cyan")
    #
    # Returns nil.
    ...
    # Example
    #
    #   Thong::Output.print("Hello World!", :color => "underline")
    #
    # Returns nil.
